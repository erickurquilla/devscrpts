...
nnu = np.zeros((2,NF))
nnu[0,0] = 1.421954234999705e+33 * 1.0
nnu[0,1] = 1.421954234999705e+33 * 0.65
nnu[1,0] = 1.421954234999705e+33 * 0.8
nnu[1,1] = 1.421954234999705e+33 * 0.5

fnu = np.zeros((2,NF,3))
fnu[0,0,:] = nnu[0,0] * np.array([0.0, 0.0, 0.6])
fnu[0,1,:] = nnu[0,1] * np.array([0.0, 0.0, 0.65])
fnu[1,0,:] = nnu[1,0] * np.array([0.0, 0.0, 0.7])
fnu[1,1,:] = nnu[1,1] * np.array([0.0, 0.0, 0.8])
